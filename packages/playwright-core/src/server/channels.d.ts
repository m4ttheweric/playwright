...
export interface AndroidSocketEventTarget {
  _dispatchEvent(event: 'data', params?: AndroidSocketDataEvent): void;
  _dispatchEvent(event: 'close', params?: AndroidSocketCloseEvent): void;
}
...
export interface AndroidDeviceEventTarget {
  _dispatchEvent(event: 'close', params?: AndroidDeviceCloseEvent): void;
  _dispatchEvent(event: 'webViewAdded', params?: AndroidDeviceWebViewAddedEvent): void;
  _dispatchEvent(event: 'webViewRemoved', params?: AndroidDeviceWebViewRemovedEvent): void;
}
...
export interface BrowserEventTarget {
  _dispatchEvent(event: 'context', params?: BrowserContextEvent): void;
  _dispatchEvent(event: 'close', params?: BrowserCloseEvent): void;
}
...
export interface BrowserContextEventTarget {
  _dispatchEvent(event: 'bindingCall', params?: BrowserContextBindingCallEvent): void;
  ...
  _dispatchEvent(event: 'webSocketRoute', params?: BrowserContextWebSocketRouteEvent): void;
  _dispatchEvent(event: 'serviceWorker', params?: BrowserContextServiceWorkerEvent): void;
  _dispatchEvent(event: 'request', params?: BrowserContextRequestEvent): void;
  _dispatchEvent(event: 'requestFailed', params?: BrowserContextRequestFailedEvent): void;
  _dispatchEvent(event: 'requestFinished', params?: BrowserContextRequestFinishedEvent): void;
  _dispatchEvent(event: 'response', params?: BrowserContextResponseEvent): void;
  _dispatchEvent(event: 'recorderEvent', params?: BrowserContextRecorderEventEvent): void;
}
...
export interface ElectronApplicationEventTarget {
  _dispatchEvent(event: 'close', params?: ElectronApplicationCloseEvent): void;
  _dispatchEvent(event: 'console', params?: ElectronApplicationConsoleEvent): void;
}
...
export interface FrameChannel extends FrameEventTarget, Channel {
  ...
  selectorCandidates(params: FrameSelectorCandidatesParams, progress: Progress): Promise<FrameSelectorCandidatesResult>;
...
export interface JSHandleEventTarget {
  _dispatchEvent(event: 'previewUpdated', params?: JSHandlePreviewUpdatedEvent): void;
}
...
export interface WebSocketRouteEventTarget {
  _dispatchEvent(event: 'messageFromPage', params?: WebSocketRouteMessageFromPageEvent): void;
  _dispatchEvent(event: 'messageFromServer', params?: WebSocketRouteMessageFromServerEvent): void;
  _dispatchEvent(event: 'closePage', params?: WebSocketRouteClosePageEvent): void;
  _dispatchEvent(event: 'closeServer', params?: WebSocketRouteCloseServerEvent): void;
}
...
export interface WebSocketEventTarget {
  _dispatchEvent(event: 'open', params?: WebSocketOpenEvent): void;
  _dispatchEvent(event: 'frameSent', params?: WebSocketFrameSentEvent): void;
  _dispatchEvent(event: 'frameReceived', params?: WebSocketFrameReceivedEvent): void;
  _dispatchEvent(event: 'socketError', params?: WebSocketSocketErrorEvent): void;
  _dispatchEvent(event: 'close', params?: WebSocketCloseEvent): void;
}
...
export interface PageEventTarget {
  _dispatchEvent(event: 'bindingCall', params?: PageBindingCallEvent): void;
  _dispatchEvent(event: 'close', params?: PageCloseEvent): void;
  _dispatchEvent(event: 'crash', params?: PageCrashEvent): void;
  _dispatchEvent(event: 'download', params?: PageDownloadEvent): void;
  _dispatchEvent(event: 'viewportSizeChanged', params?: PageViewportSizeChangedEvent): void;
  _dispatchEvent(event: 'fileChooser', params?: PageFileChooserEvent): void;
  _dispatchEvent(event: 'frameAttached', params?: PageFrameAttachedEvent): void;
  _dispatchEvent(event: 'frameDetached', params?: PageFrameDetachedEvent): void;
  _dispatchEvent(event: 'locatorHandlerTriggered', params?: PageLocatorHandlerTriggeredEvent): void;
  _dispatchEvent(event: 'route', params?: PageRouteEvent): void;
  _dispatchEvent(event: 'screencastFrame', params?: PageScreencastFrameEvent): void;
...
export interface DebugControllerEventTarget {
  _dispatchEvent(event: 'inspectRequested', params?: DebugControllerInspectRequestedEvent): void;
  _dispatchEvent(event: 'setModeRequested', params?: DebugControllerSetModeRequestedEvent): void;
  _dispatchEvent(event: 'stateChanged', params?: DebugControllerStateChangedEvent): void;
  _dispatchEvent(event: 'sourceChanged', params?: DebugControllerSourceChangedEvent): void;
  _dispatchEvent(event: 'paused', params?: DebugControllerPausedEvent): void;
}
...
export interface SocksSupportEventTarget {
  _dispatchEvent(event: 'socksRequested', params?: SocksSupportSocksRequestedEvent): void;
  _dispatchEvent(event: 'socksData', params?: SocksSupportSocksDataEvent): void;
  _dispatchEvent(event: 'socksClosed', params?: SocksSupportSocksClosedEvent): void;
}
...
export interface JsonPipeEventTarget {
  _dispatchEvent(event: 'message', params?: JsonPipeMessageEvent): void;
  _dispatchEvent(event: 'closed', params?: JsonPipeClosedEvent): void;
}
...
export interface CDPSessionEventTarget {
  _dispatchEvent(event: 'event', params?: CDPSessionEventEvent): void;
  _dispatchEvent(event: 'close', params?: CDPSessionCloseEvent): void;
}
...
export interface WorkerEventTarget {
  _dispatchEvent(event: 'console', params?: WorkerConsoleEvent): void;
  _dispatchEvent(event: 'close', params?: WorkerCloseEvent): void;
}
